...
import { GQLRequest } from 'https://deno.land/x/gql@1.1.1/types.ts';
import { RenderPageOptions } from './render.ts';

// !!! all code below is from https://deno.land/x/gql@1.1.1/common.ts
